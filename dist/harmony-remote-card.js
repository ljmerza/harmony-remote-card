...
/* eslint no-console: 0 */
console.info(`${_package_json__WEBPACK_IMPORTED_MODULE_2__.name} v${_package_json__WEBPACK_IMPORTED_MODULE_2__.version}`);

class HarmonyRemoteCard extends lit_element__WEBPACK_IMPORTED_MODULE_1__["LitElement"] {
  ...
  setConfig(config) {
    ...
    this.config = { ..._defaults__WEBPACK_IMPORTED_MODULE_4__["default"], ...config };
  }
   ...
   */
  render() {
    return lit_element__WEBPACK_IMPORTED_MODULE_1__["html"]`<ha-card>${this.renderBody()}</ha-card>`;
  }

  renderBody() {
    return lit_element__WEBPACK_IMPORTED_MODULE_1__["html"]`<div class="harmony">
